...
public class Server implements ActionListener {
    ...
    Server() {
        ...
        //User Image
        ImageIcon i4 = new ImageIcon(getClass().getResource("icons/user.png"));
        ...
        //Setting Panel For Text Messages
        a1 = new JPanel();
        ...
        //Setting Additional Frame Attributes
        f.setSize(450, 700);
    ...
    public void actionPerformed(ActionEvent ae) {
        try {
            ...
            //For Displaying Messages In Right And One After Other
            ...
            //Setting Frame State After Each Message
            dout.writeUTF(out);
            text.setText("");
            f.repaint();
            f.invalidate();
    ...
    public static JPanel formatLabel(String out) {
        ...
        //Setting Panel For Individual Message
        ...
        //Displaying Time Of Each Message Delivered 
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //Initialising Server Socket For Connection
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    //Displaying Client Messages In Left
